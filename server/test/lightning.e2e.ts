...
async function main() {
  ...
  try {
    ...
    ok("QR is an uppercase LIGHTNING: BOLT11 URI", inst.qr.startsWith("LIGHTNING:LNBC"));
  ...
  try {
    ...
    ok("instruction QR is the uppercase LIGHTNING: URI", li.qr === "LIGHTNING:LNBC1304140N1PJMOCKED");

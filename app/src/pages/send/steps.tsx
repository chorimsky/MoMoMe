...
// Every crypto pay-in method the product supports. What a customer actually sees is this
// list filtered by the server's `methods` flags (GET /config), so an operator switching one

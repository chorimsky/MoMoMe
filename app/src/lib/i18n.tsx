...
export const STRINGS: Dict = {
  /* ---------- /send-abroad — Mobile Money to another country ---------- */
  ...
  err_unauthorized: ["Open this page from the app or your usual browser — we couldn't recognise your device.", "Ouvrez cette page depuis l'app ou votre navigateur habituel — appareil non reconnu."],
  ...
  checking_name: ["Checking name…", "Vérification du nom…"],
  ...
  recommended: ["RECOMMENDED", "RECOMMANDÉ"], cancel_payment: ["Cancel this payment", "Annuler ce paiement"], cancel_confirm: ["Cancel this payment? Only do this if you have NOT sent anything yet.", "Annuler ce paiement ? Seulement si vous n'avez encore RIEN envoyé."], m_unavailable_now: ["Not available right now", "Indisponible pour le moment"], large_hint: ["For larger amounts, Bitcoin settles more securely.", "Pour les gros montants, Bitcoin est plus sûr."],
  ...
  receipt_success: ["Payment Successful", "Paiement réussi"],
  receipt_pending: ["Payment pending", "Paiement en cours"], receipt_failed: ["Payment failed", "Paiement échoué"],
  receipt_delivered_to: ["{amount} delivered to {who}", "{amount} envoyés à {who}"],
  receipt_intended_for: ["{amount} to {who}", "{amount} pour {who}"],
  receipt_you_paid: ["You paid", "Vous avez payé"],
  receipt_tagline: ["Mobile Money, made simple — momome.xyz", "Mobile Money, en toute simplicité — momome.xyz"], amount_delivered: ["Amount delivered", "Montant livré"], total_paid: ["Total paid", "Total payé"],
  ...
  receipt_show_crypto: ["Show how I paid", "Afficher mon paiement"],
  ...
  cap_hint: ["The most you can send to one number at once is 1,000,000 XAF.", "Le maximum par envoi vers un numéro est de 1 000 000 XAF."],
  kyc_hint: ["For transfers of 1,000,000 XAF or more, we may ask you to confirm your identity — a legal requirement for larger payments.", "Pour les transferts de 1 000 000 XAF ou plus, nous pouvons vous demander de confirmer votre identité — une obligation légale pour les montants élevés."],
  ...
  retry_delivery_offer_sub: ["The Mobile Money payout didn't go through. We can try again — often on another payout partner — before refunding you.", "Le versement Mobile Money n'est pas passé. Nous pouvons réessayer — souvent via un autre partenaire — avant de vous rembourser."],
  retry_delivery_btn: ["Try sending to {n} again", "Réessayer l'envoi à {n}"],
  retry_delivery_title: ["Trying again…", "Nouvelle tentative…"],
  retry_delivery_sub: ["The payout is being sent again. This usually takes under a minute.", "Le versement est renvoyé. Cela prend généralement moins d'une minute."],
  ...
  rcv_lede: ["Share one code. Anyone can pay you from anywhere — and it arrives on your Mobile Money in seconds.", "Partagez un seul code. N'importe qui peut vous payer, où qu'il soit — et l'argent arrive sur votre Mobile Money en quelques secondes."],
  ...
  rcv_your_link: ["Your payment link", "Votre lien de paiement"],
  rcv_link_label: ["Payment link", "Lien de paiement"],
  rcv_share_btn: ["Share link + QR", "Partager le lien + QR"],
  rcv_save_qr: ["Save QR image", "Enregistrer le QR"],
  rcv_saved: ["Saved ✓", "Enregistré ✓"],
  rcv_card_foot: ["Scan with any phone camera, or open the link.", "Scannez avec n'importe quel téléphone, ou ouvrez le lien."],
  ...
  req_kicker: ["Payment request", "Demande de paiement"],
  req_someone: ["Someone asked you to pay", "On vous demande un paiement"],
  req_asked: ["requested", "demandés"],
  req_open: ["They left the amount up to you.", "Le montant est laissé à votre choix."],
  rcv_who: ["This code pays", "Ce code paie"],
  rcv_amount_requested: ["Amount requested", "Montant demandé"],
  ...
  // "Choose how to pay" listed a name and a vague subtitle, so the sender picked blind.
  m_you_send: ["You send", "Vous envoyez"],
  m_eta_seconds: ["Arrives in seconds", "Arrive en quelques secondes"],
  m_eta_minutes: ["2–5 min from a wallet · up to 60 min from an exchange", "2 à 5 min depuis un portefeuille · jusqu'à 60 min depuis une plateforme"],
  m_eta_onchain: ["Usually 10–60 minutes", "En général 10 à 60 minutes"],
  m_network_fee: ["Your wallet also pays a network fee", "Votre portefeuille paie aussi des frais de réseau"],
  m_indicative: ["Amounts are indicative — your exact rate is locked on the next step.", "Montants indicatifs — votre taux exact est fixé à l'étape suivante."],
  m_none: ["No payment methods are available right now. Please try again shortly.", "Aucun moyen de paiement n'est disponible pour le moment. Réessayez bientôt."],
  ...
  // Recipient checks — the SAME refusals the server applies, shown beside the field while
  // the number is being typed instead of on the fourth screen.
  ...
  operator_detected: ["Read from the number — the money always goes to the operator that owns it.", "Déduit du numéro — l'argent va toujours à l'opérateur propriétaire du numéro."],
  ...
  exchange_delay_title: ["Sending from an exchange (Coinbase, Binance, Kraken…)?", "Vous envoyez depuis une plateforme (Coinbase, Binance, Kraken…) ?"],
  exchange_delay_sub: ["Exchanges batch withdrawals, so yours can take 30–60 minutes to leave. That is fine: this address stays yours, we watch it, and the Mobile Money is delivered the moment the transfer lands — even if you close this page.", "Les plateformes regroupent les retraits : le vôtre peut mettre 30 à 60 minutes à partir. Aucun souci : cette adresse reste la vôtre, nous la surveillons, et le Mobile Money est livré dès que le transfert arrive — même si vous fermez cette page."],
  ...
  cr_registered: ["The operator registers this number to", "L'opérateur enregistre ce numéro au nom de"],
  name_mismatch: ["You entered this number as {n}. It is registered to a different name — make sure this is the person you mean.", "Vous avez saisi ce numéro sous {n}. Il est enregistré sous un autre nom — vérifiez qu'il s'agit bien de la bonne personne."],
  contacts_registered: ["Registered to", "Enregistré au nom de"],
  contacts_name_differs: ["“{n}” is not the registered name for this number.", "« {n} » n'est pas le nom enregistré pour ce numéro."],
  contacts_use_name: ["Use the registered name", "Utiliser le nom enregistré"],
  resume_title: ["Your payment is still open", "Votre paiement est toujours ouvert"],
  resume_sub: ["We brought you back to it. If you've already paid, it will be delivered on its own.", "Nous vous y avons ramené. Si vous avez déjà payé, il sera livré automatiquement."],
  ...
  err_no_device: ["This device isn't recognised — reload the page and try again.", "Cet appareil n'est pas reconnu — rechargez la page et réessayez."],
  ...
  onchain_estimate: ["The final amount is set when your Bitcoin payment confirms — it may be a little more or less than shown.", "Le montant final est fixé à la confirmation de votre paiement Bitcoin — il peut être légèrement supérieur ou inférieur à celui affiché."],
  amount_quoted: ["Quoted", "Estimé"],
  repriced_final_rate: ["final rate", "taux final"],
  ...
  faq5_q: ["Can I pay from Cash App in the USA?", "Puis-je payer depuis Cash App aux États-Unis ?"],
  faq5_a: ["Yes. In Cash App tap the $ tab, tap the QR scanner at the top left, scan the MoMo›Me code (or choose Paste Address and paste the Instant payment code), pick Cash or Bitcoin as the source, then Confirm and pay. Cash App converts your dollars itself — you never hold bitcoin — and the Mobile Money lands in seconds. Funding from your cash balance adds Cash App's 0.9% fee.", "Oui. Dans Cash App, touchez l'onglet $, puis le scanner QR en haut à gauche, scannez le code MoMo›Me (ou choisissez Coller l'adresse et collez le code de paiement instantané), choisissez Cash ou Bitcoin comme source, puis Confirmer et payer. Cash App convertit vos dollars lui-même — vous ne détenez jamais de bitcoin — et le Mobile Money arrive en quelques secondes. Payer depuis le solde en dollars ajoute les 0,9 % de frais de Cash App."],
  faq6_q: ["Which apps can pay a MoMo›Me code?", "Quelles applications peuvent payer un code MoMo›Me ?"],
  faq6_a: ["Any app that pays a Lightning invoice: Cash App and Strike in the USA, Wallet of Satoshi, Phoenix, Blink, Muun and most Bitcoin wallets worldwide. For the Bitcoin and US Dollars options, any exchange or wallet that sends on-chain bitcoin or USDT/USDC on Ethereum.", "Toute application qui paie une facture Lightning : Cash App et Strike aux États-Unis, Wallet of Satoshi, Phoenix, Blink, Muun et la plupart des portefeuilles Bitcoin dans le monde. Pour les options Bitcoin et Dollars US, tout exchange ou portefeuille qui envoie du bitcoin on-chain ou de l'USDT/USDC sur Ethereum."],
  ...
  app_get_it_on: ["Get it on", "Disponible sur"],
  app_download_on: ["Download on the", "Télécharger dans l'"],
  app_direct_download: ["Direct download", "Téléchargement direct"],
  app_direct_download_lc: ["direct download", "téléchargement direct"],
  app_coming_soon: ["Coming soon", "Bientôt"],
  app_banner_title: ["MoMo›Me app", "L'app MoMo›Me"],
  app_banner_sub: ["free · faster", "gratuite · plus rapide"],
  app_banner_cta: ["Get app", "Installer"],
  app_banner_close: ["Not now", "Pas maintenant"],
  lp_cta_app: ["Get the app", "Télécharger l'app"],
  lp_app_title: ["Get the MoMo›Me app", "Téléchargez l'app MoMo›Me"],
  lp_app_sub: ["Send, receive and get paid from your pocket. Free on Android and iPhone.", "Envoyez, recevez et encaissez depuis votre poche. Gratuite sur Android et iPhone."],
  lp_or_web: ["or continue on the web", "ou continuer sur le web"],
  ...
  mrc_merchant_code: ["Merchant", "Marchand"],
  fee_by_merchant: ["Paid by the business", "Pris en charge par le commerce"],
  mrc_price_note: ["You pay exactly the price shown; the business covers the fee.", "Vous payez exactement le prix affiché ; le commerce prend les frais en charge."],
  mrc_price_label: ["Price", "Prix"],
  paid_to: ["paid to", "payé à"],
  mrc_feemode_title: ["Who pays the fee", "Qui paie les frais"],
  mrc_feemode_customer: ["My customers — added on top of the price", "Mes clients — ajoutés au prix"],
  mrc_feemode_merchant: ["Me — customers pay the exact price, I receive price minus the fee", "Moi — les clients paient le prix exact, je reçois le prix moins les frais"],
  mrc_feemode_hint: ["Like card acceptance: a 0-fee price converts better. The fee is the same either way.", "Comme l'acceptation carte : un prix sans frais convertit mieux. Les frais sont identiques dans les deux cas."],
  mrc_feemode_ex: ["On a {p} XAF sale", "Sur une vente de {p} XAF"],
  mrc_feemode_ex_pays: ["customer pays", "le client paie"],
  mrc_feemode_ex_gets: ["you receive", "vous recevez"],
  mrc_lt_amount_range: ["A customer can pay between {min} and {max} XAF in one payment — set an amount in that range, or leave it open.", "Un client peut payer entre {min} et {max} XAF en un paiement — choisissez un montant dans cette plage, ou laissez-le libre."],
  mrc_pay_biz_title: ["Pay {n}", "Payer {n}"],
  mrc_pay_biz_sub: ["The business receives Mobile Money the moment your payment arrives.", "Le commerce reçoit le Mobile Money dès l'arrivée de votre paiement."],
  mrc_amount_q: ["How much are you paying?", "Combien payez-vous ?"],
  mrc_biz_verified: ["Verified business — settles to its Mobile Money", "Commerce vérifié — réglé sur son Mobile Money"],
  mrc_biz_unverified: ["This business hasn't verified its number yet", "Ce commerce n'a pas encore vérifié son numéro"],
  ...
  mrc_inv_paid_t: ["This invoice is already paid", "Cette facture est déjà réglée"],
  mrc_inv_paid_d: ["Nothing more to pay to", "Plus rien à payer à"],
  ...
  disc_sub: ["Businesses that accept MoMo›Me — pay them in seconds and they receive Mobile Money instantly.", "Des commerces qui acceptent MoMo›Me — payez-les en quelques secondes, ils reçoivent du Mobile Money instantanément."],
  ...
  mrc_o_sub: ["Your customers pay however they like; you receive Mobile Money instantly. Set up your business in a minute — no bank, no card machine.", "Vos clients paient comme ils veulent ; vous recevez du Mobile Money instantanément. Configurez votre commerce en une minute — sans banque, sans TPE."],
  ...
  mrc_v_send: ["Send me a code", "M'envoyer un code"],
  mrc_v_send_hint: ["We'll send a 6-digit code to this number on WhatsApp, or by SMS if it isn't on WhatsApp.", "Nous envoyons un code à 6 chiffres à ce numéro sur WhatsApp, ou par SMS s'il n'est pas sur WhatsApp."],
  ...
  otp_sent: ["Code sent.", "Code envoyé."],
  ...
  // ---- Merchant: dashboard ----
  mrc_d_verified: ["Verified · instant settlement", "Vérifié · règlement instantané"],
  mrc_d_unverified: ["Number not verified", "Numéro non vérifié"],
  mrc_d_verify_cta: ["Verify now", "Vérifier maintenant"],
  mrc_d_unverified_hint: ["Payment links and the public badge unlock once you confirm the number that receives your payouts. It takes one code, on WhatsApp or by SMS.", "Les liens de paiement et le badge public s'activent une fois le numéro qui reçoit vos paiements confirmé. Un seul code suffit, sur WhatsApp ou par SMS."],
  mrc_d_edit: ["Edit details", "Modifier les infos"],
  mrc_d_code_hint: ["Customers can also type this code in the app instead of scanning.", "Vos clients peuvent aussi saisir ce code dans l'app au lieu de scanner."],
  mrc_v_later: ["Do this later", "Plus tard"],
  mrc_v_resend: ["Resend code", "Renvoyer le code"],
  mrc_d_verified_short: ["Verified", "Vérifié"],
  mrc_lt_title_short: ["Get paid", "Encaisser"],
  mrc_lt_amount_short: ["Amount", "Montant"],
  mrc_lt_label_short: ["Label", "Libellé"],
  mrc_lt_disable_confirm: ["Disable this link? Customers who open it will be told it is no longer active.", "Désactiver ce lien ? Les clients qui l'ouvrent verront qu'il n'est plus actif."],
  ...
  mrc_d_week: ["Last 7 days", "7 derniers jours"],
  // ---- Merchant: Lightning identity ----
  mrc_ln_title: ["Get paid from any Bitcoin wallet", "Encaissez depuis n'importe quel portefeuille Bitcoin"],
  mrc_ln_desc: ["Your business has a Lightning Address. A customer with a Bitcoin app pays it — you receive Mobile Money, and the sale shows here.", "Votre commerce a une adresse Lightning. Un client avec une application Bitcoin la paie — vous recevez du Mobile Money, et la vente apparaît ici."],
  mrc_ln_on: ["Lightning on", "Lightning activé"],
  mrc_ln_off_unverified: ["Verify your number to show your business name to wallets and see these sales here.", "Vérifiez votre numéro pour afficher le nom de votre commerce aux portefeuilles et voir ces ventes ici."],
  mrc_ln_off_suspended: ["Lightning is off while the account is suspended.", "Lightning est désactivé tant que le compte est suspendu."],
  mrc_ln_payer_sees: ["A wallet paying this address sees:", "Un portefeuille qui paie cette adresse voit :"],
  mrc_ln_qr: ["Wallet QR", "QR portefeuille"],
  mrc_ln_hide_qr: ["Hide QR", "Masquer le QR"],
  mrc_ln_copied: ["Address copied", "Adresse copiée"],
  mrc_d_live: ["Updates live", "Mise à jour en direct"],
  mrc_d_new_sale: ["New sale", "Nouvelle vente"],
  mrc_d_export: ["Export CSV", "Exporter CSV"],
  mrc_d_export_done: ["Sales exported", "Ventes exportées"],
  mrc_d_via_link: ["via link", "via lien"],
  mrc_d_via_qr: ["via QR", "via QR"],
  mrc_d_via_invoice: ["invoice", "facture"],
  mrc_d_via_address: ["Lightning Address", "Adresse Lightning"],
  mrc_d_via_code: ["via merchant code", "via code marchand"],
  mrc_d_fee_absorbed: ["fee absorbed", "frais absorbés"],
  mrc_d_customer_paid: ["customer paid", "le client a payé"],
  mrc_d_ref_copied: ["Reference copied", "Référence copiée"],
  mrc_d_delivered_at: ["Delivered", "Livré"],
  ...
  mrc_ps_3: ["Pay in seconds — it's instant", "Payez en quelques secondes — c'est instantané"],
  mrc_ps_footer: ["Instant Mobile Money settlement · No account needed to pay", "Règlement Mobile Money instantané · Aucun compte requis pour payer"],
  mrc_ps_accept: ["MoMo›Me accepted here", "MoMo›Me accepté ici"],
...
const METHOD_EN_ARRIVAL: Record<Method, string> = {
  ...
  USDT: "2–5 min · up to 60 min from an exchange",
  USDC: "2–5 min · up to 60 min from an exchange",
};

...
export const STRINGS: Dict = {
  ...
  mrc_d_unverified_hint: ["Payment links and the public badge unlock once you confirm the number that receives your payouts. It takes one SMS code.", "Les liens de paiement et le badge public s'activent une fois le numéro qui reçoit vos paiements confirmé. Un seul code SMS suffit."],

...
// Exactly the routes the app has: pay/[code], m/[code] (the counter-poster QR — a poster
// scanned with the phone camera must open the app, not a browser tab), send.
const APP_PATHS = ["/pay/*", "/m/*", "/send"];

/* ============================================================
   ...
   ============================================================ */
import type { ProviderId, Aggregator, RoutingSnapshot, AggregatorHealth, ExecutionLogEntry } from "../../../shared/types.js";
...
const AGGREGATORS: Record<Aggregator, AggregatorAdapter> = {
  pawapay: { name: "pawapay", disburse: pawapay.disburse, queryStatus: pawapay.queryStatus },
  peexit: { name: "peexit", disburse: peexit.disburse, queryStatus: peexit.queryStatus },
};
